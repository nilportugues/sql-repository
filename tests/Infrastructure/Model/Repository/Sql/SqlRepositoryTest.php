...
class SqlRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAddWhenAutoGeneratedIdTrue()
    {
        ...
        $repository = new CustomerRepository($this->pdo, $mapping);

        $customer = new Customer(null, 'Ken Sugimori', 4, 69158.687, new DateTime('2010-12-10'));
        $customer = $repository->add($customer);

        $this->assertNotNull($repository->find(new CustomerId($customer->id())));
    }
    ...
    public function testAddAllWhenAutoGeneratedIdTrue()
    {
        ...
        $customer5 = new Customer(null, 'New Client 1', 4, 69158.687, new DateTime('2010-12-10'));
        $customer6 = new Customer(null, 'New Client 2', 4, 69158.687, new DateTime('2010-12-10'));
        $customers = [$customer5, $customer6];

        $values = $repository->addAll($customers);

        $this->assertNotNull($repository->find(new CustomerId($values[0]->id())));
        $this->assertNotNull($repository->find(new CustomerId($values[1]->id())));
    }
    ...
    public function testAddAutoGeneratedIdFalse()
    {
